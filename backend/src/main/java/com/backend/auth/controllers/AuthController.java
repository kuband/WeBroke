...
import com.backend.auth.event.OnRegistrationCompleteEvent;
...
import com.backend.auth.payload.request.LoginRequest;
import com.backend.auth.payload.request.SignupRequest;
import com.backend.auth.payload.response.MessageResponse;
import com.backend.auth.payload.response.UserInfoResponse;
import com.backend.auth.repository.RoleRepository;
import com.backend.auth.security.jwt.JwtUtils;
import com.backend.auth.security.services.*;
...
import static com.backend.common.util.RequestUtil.getAppUrl;
